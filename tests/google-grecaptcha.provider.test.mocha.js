describe('googleGrecaptcha provider', function (){
  ...
  describe('with specific language', function (){
    ...
    it('should add script element with correct url', function (){
      expect($document.find('body').html()).to.contain('<script type="application/javascript" src="https://www.recaptcha.com/recaptcha/api.js?onload=recaptchaOnloadCallback&amp;render=explicit&amp;hl=fi"></script>')
    });
  });
});
